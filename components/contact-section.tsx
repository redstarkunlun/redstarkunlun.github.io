  ...
  return (
    <section id="contact" className="py-20 px-4">
      <div className="container mx-auto max-w-4xl">
        <div className="glass-card rounded-2xl p-8 md:p-12 space-y-10 text-center border border-white/10 relative overflow-hidden">
          {/* 动态的グラデーション効果を追加 */}
          ...
          <div className="space-y-3 relative z-10">
            <h2 className="text-4xl md:text-5xl font-bold text-white relative inline-block">
              Contact
              <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full" />
            </h2>
